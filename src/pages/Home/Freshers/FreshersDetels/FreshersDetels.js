...
const FreshersDetels = () => {
    const fersherDetails = useLoaderData()
    const {name,company,img,description,job,job_Requirements,location,_id} = fersherDetails
    return (
