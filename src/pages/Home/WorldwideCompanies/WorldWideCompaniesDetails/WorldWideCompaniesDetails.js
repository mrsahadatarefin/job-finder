...
const WorldWideCompaniesDetails = () => {
    const WorldWideCompaniesDetails = useLoaderData()
    const {name,company,img,description,job,job_Requirements,location,_id}=WorldWideCompaniesDetails
    return (
...
export default WorldWideCompaniesDetails;