...
const TopBangladeshDetails = () => {
    const TopBangladesh = useLoaderData()
    const {name,company,img,description,job,job_Requirements,location,_id}=TopBangladesh
    return (
...
export default TopBangladeshDetails;